 ...
 * This class represents a 2D Point in the plane.
 * ToString- Converts the Point data to String.
 * Add-Calculate the sum of two X, Y values.
 * Contains-Check if curtain point is in the Circle area.
 * Dictance- Calculate the distance between two points.
 * Move-Move the Circle according to given vector.
 * Scale - decreases or increases the Point according to given percentage.
 * Rotate - Rotate the Point by a given angle.
 * equals - check equality between two given Points.
 * close2equals- check equality up to epsilon between two given Points.
 * notClose2equals - check inequality up to epsilon between two given Points
 * Vector - This method returns the vector between this point and the target point. The vector is represented as a Point2D.
 */
...
public class Point_2D {
    ...
    public boolean notClose2equals(Point_2D p2, double eps)
    {
        return ( this.distance(p2) > eps );
    }
