...
/**
 * Taliya Vallerstein.- ID: 324866680
 ...
 * Ex2 project is a program thet draw 2D shapes as-Triangle, Circle, Rectangle, Polygon,Segment, and alowes actions that apply to the shapes.
 * rotate- rotate the shape around given point and degrees.
 * scale- decreases or increases the shape according to given percentage.
 * sort- sort all the drwa shapes according to a given demend parameter.
 * move- Move the shapes according to given vector.
 * remove shapes.
 * copy- copy the sallect shape
 * color- coloring the shape according to a demend color.
 * save- saveing the file of the drwen shapes.
 * loed- loeding a save file and show it.
 *
 */
